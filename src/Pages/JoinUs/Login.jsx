...
const Login = () => {
    ...
    return (
        <div className="pt-4">
            <Helmet>
                <title>Medical Capm | Login</title>
            </Helmet>
                    ...
                    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl mt-4 p-6">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-control mt-2">
                                <button className="w-full px-6 py-3 text-base text-white font-medium my-2 bg-gray-700 rounded-lg hover:bg-gray-800">Login</button>
                            </div>
