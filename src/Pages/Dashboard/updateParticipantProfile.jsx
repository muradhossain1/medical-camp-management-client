            ...
            <form onSubmit={handleSubmit(onSubmit)} >
                <div className="md:w-1/2 mx-auto">
                    ...
                    <label className="form-control w-full  ">
                        ...
                        <input
                            {...register("address")}
                            type="text" placeholder="Address" defaultValue={address} className="input input-bordered w-full" required />
                    </label>
                    {/* contact*/}
                    <label className="form-control w-full  ">
                        <div className="label">
                        ...
                        <input
                            {...register("phone")}
                            type="number" placeholder="Contact Number" defaultValue={phone} className="input input-bordered w-full" required />
                    </label>
