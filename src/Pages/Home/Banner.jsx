        ...
        <div className="carousel w-full">
            ...
            >
                <SwiperSlide id="slide1" className="carousel-item relative w-full">
                    <div
                        className='w-full bg-center bg-cover object-cover h-[26rem]'
                        style={{
                            backgroundImage: `url('https://i.ibb.co.com/hYgDgXp/banner-1.png')`,
                        }}
                    >
                ...
                <SwiperSlide id="slide1" className="carousel-item relative w-full">
                    <div
                        className='w-full bg-center bg-cover object-cover h-[26rem]'
                        style={{
                            backgroundImage: `url('https://i.ibb.co.com/xs3FcfF/banner-3.jpg')`,
                        }}
                    >
                        <div className='flex items-center justify-center w-full h-full bg-gray-700/60 '>
                            <div className=''>
                ...
                <SwiperSlide id="slide1" className="carousel-item object-cover relative w-full">
                    <div
                        ...
                        style={{
                            backgroundImage: `url('https://i.ibb.co.com/BtQhQ5t/banner-2.png')`,
                        }}
                    >
                        <div className='flex items-center justify-center w-full h-full bg-gray-700/60 '>
                            <div className=''>
